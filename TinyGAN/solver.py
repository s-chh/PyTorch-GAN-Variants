...
class Solver(object):
	def __init__(self, args):
		...
		self.gen = Generator(z_dim=self.args.z_dim, image_size=self.args.image_size, n_channels=self.args.n_channels)
		self.dis = Discriminator(image_size=self.args.image_size, n_channels=self.args.n_channels)
