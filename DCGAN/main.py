...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='DCGAN-64x64')

    # Data arguments
    parser.add_argument('--dataset', type=str.lower, default='mnist', choices=['celeba', 'mnist', 'lsun_church', 'lsun_bedroom'], help='dataset to use')
