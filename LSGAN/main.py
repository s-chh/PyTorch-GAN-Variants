...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='LSGAN-112x112')

    # Data arguments
    parser.add_argument('--dataset', type=str.lower, default='mnist', choices=['mnist', 'celeba', 'lsun_church', 'lsun_bedroom'], help='dataset to use')
    ...
    parser.add_argument('--z_dim', type=int, default=50, help='sample noise dimensions')
